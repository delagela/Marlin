...
#define CUSTOM_MACHINE_NAME "Delage Prusa I3"
...
// activated Z_PROBE_/ENDSTOP below. If you are using the Z Min endstop on your Z Probe,
// this has no effect.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000,350} // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {500, 500, 2, 25}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {1000,1000,20,400}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
...
#define LCD_FEEDBACK_FREQUENCY_HZ 50	// this is the tone frequency the buzzer plays when on UI feedback. ie Screen Click
